class DropBoxController {
    ...
    connectFirebase(){
          ...
          // COnnect with the database (commands from the website)
        var firebaseConfig = {
            apiKey: "AIzaSyCx1wwcHODgJV4Fy5RXQJKHkn34gqoCFmo",
            authDomain: "dropbox-clone-aad0f.firebaseapp.com",
            databaseURL: "https://dropbox-clone-aad0f.firebaseio.com",
            projectId: "dropbox-clone-aad0f",
            storageBucket: "dropbox-clone-aad0f.appspot.com",
            messagingSenderId: "557054014437",
            appId: "1:557054014437:web:35743e5ae3668eb277b50c",
            measurementId: "G-8LB6G5MGQE"
        };
        // Initialize Firebase
        ...
        return new Promise((resolve, reject) =>{
            ...
            folderRef.on('value', snapshot =>{
                ...
                if (snapshot.exists()) {
                    ...
                    this.getFirebaseRef('frederico').child(key).remove();
